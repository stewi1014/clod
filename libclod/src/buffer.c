...
char *string_copy(void*(*malloc_f)(size_t), const char *str, ...) {
    va_list va;
    va_start(va, str);
...
char *string_concat(char **tmp_string, size_t *tmp_string_cap, void*(*realloc_f)(void *, size_t), const char *elem, ...) {
    va_list va;
    va_start(va, elem);
